...
class ColorUtility(object):
    '''
        Color utility class
    '''
    thirdy_distinct_colors = ['#ff0505', '#f2a041', '#cdff05', '#04d9cb', '#45a8ff', '#8503a6', '#590202', '#734d02',
                              '#4ab304',
                              '#025359', '#0454cc', '#ff45da', '#993829', '#ffda45', '#1c661c', '#05cdff', '#1c2f66',
                              '#731f57',
                              '#b24a04', '#778003', '#0e3322', '#024566', '#0404d9', '#e5057d', '#66391c', '#31330e',
                              '#3ee697',
                              '#2d7da6', '#20024d', '#33011c']

    five_distinct_colors = [ 'blue', 'red','green', 'gold', 'cyan']

    many_distinct_color_dict = {'aliceblue': '#F0F8FF', 'antiquewhite': '#FAEBD7',
    ...
    color_schemes = {'short': five_distinct_colors,
                    'large':list(many_distinct_color_dict.keys()),
                     'medium': thirdy_distinct_colors}
